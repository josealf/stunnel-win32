...
The official stunnel.org site no longer provides 32-bit binaries for Windows. This is provided as a convenience for stunnel users.
 ...
 Starting with version 5.78 a new experimental build has been published. I named the installer file stunnel-win32-5.78.<b>1</b>.testing-openssl-3.0.20-installer.exe. This special build includes UI and other minor enhacements that are not in the official Stunnel software.
